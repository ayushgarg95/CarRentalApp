...
<html>
<head>
	<title>AAA Car Rental System</title>
...
<nav class="navbar navbar-inverse bg_header">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <a class="navbar-brand" href="#">AAA Car Rental System</a>
    </div>
...
<?php
require_once('C:\wamp\www\car\calendar\tc_calendar.php');
	  $myCalendar = new tc_calendar("date1", true, false);
	  $myCalendar->setIcon("calendar/images/iconCalendar.gif");
	  $myCalendar->setPath("calendar/");
	  $myCalendar->setYearInterval(2017, 2020);
	  $myCalendar->dateAllow("2017-04-07","2018-04-01");
...
?>
		...
		<div class="form-group">
			...
			<input type="text" class="form-control"  placeholder="SUV/Sedan/Luxury/MUV"  name="Ctype" style="width: 20%;">
		  </div
		  <br>
