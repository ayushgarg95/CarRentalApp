...
<div class="container">
  ...
  <div class="btn-group btn-group-justified" role="group" >
    <a href="admin-previous.php" role="button" class="btn btn-default btn-lg ">Previous Bookings</a>
    <a href="home2.php" role="button" class="btn btn-default btn-lg">Current Bookings</a>
    <a href="admin-future.php" role="button" class="btn btn-default btn-lg active">Future Bookings</a>
  </div>
